...
class MPCPublisherNode(Node):
    def __init__(self):
        ...
        self.curr_acc_sub = self.create_subscription(Float64, '/control/throttle', self.steer_callback, 1)
        self.curr_throttle_sub = self.create_subscription(Float64, '/control/steer', self.acceleration_callback, 1) 
