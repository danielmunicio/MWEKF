...
class FileOperations:
    ...
    def get_intrinsic_parameters(UTILITIES_PATH, realsenseCamera):
        file_path = '/home/dhruvagarwal/Downloads/logitech_intrinsic_parameters.txt' 
        if realsenseCamera:
            file_path = '/home/dhruvagarwal/Downloads/realsense_intrinsic_parameters.txt'
    ...
    def get_extrinsic_parameters(UTILITIES_PATH, realsense = True):
        if realsense:
            data = np.load('/home/dhruvagarwal/feb-system-integration/sensor_fusion/Extrinsic_Camera_Calibration/src/lidar_camera_calibration/utilities/extrinsics.npz')
        else:
            data = np.load('/home/dhruvagarwal/feb-system-integration/sensor_fusion/Extrinsic_Camera_Calibration/src/lidar_camera_calibration/utilities/logitech_extrinsics.npz')
