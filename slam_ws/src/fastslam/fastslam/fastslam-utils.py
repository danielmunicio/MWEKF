...
class FastSLAM:
    ...
    """
    def fastslamit(self, particles: list[Particle], dx: np.array, z: list) -> list[Particle]:
        # Move particles
        particles = self.predict_poses(particles, dx)
        ...
        # Resample particles
        self.resample_particles(particles, N, W_MIN)
        # Return all particles
        return particles



    def predict_poses(self, particles, dx):
        for particle in particles:
    ...
    """
    def data_assoc(self, list_of_cones: list, obs_cone: tuple) -> tuple:
    ...
    def resample_particles(self, particles, num_particles, w_min):
