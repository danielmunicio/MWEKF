...
class SensorFusion(Node):
    ...
    def get_dist_angle_classes(self, is_realsense=False):
        ...
        P = camera_matrix @ RT
        intensities = ros2_numpy.point_cloud2.point_cloud2_to_array(self.velodyne_msg)['intensity']
    ...
    def project_point_cloud(self):
        if self.logitech_image_msg is None:
            return
        median_distances, angles, chosen_classes = self.get_dist_angle_classes(is_realsense=False)
